...
enum Pirim {
  ...
  Range = 'range',
  NM = 'nm',
  LinearFibo = 'linear-fibo',
  DB = 'db',
  SegtreeLazy = 'segtree-lazy',
  G3_1Try = 'g3-1try',
  ModNeg = 'mod-neg',
  Goin = 'goin',
  Nande = 'nande',
  DiaEscape = 'dia-escape',
  NextPermuation = 'next-permuation',
  Translate = 'translate',
  Choragi = 'choragi',
  Counter = 'counter',
  CodeForcesData = 'cf-data',
  Solved = 'solved',
  CodeForcesHacked = 'cf-hacked',
  DirtyGoinmul = 'dirty-goinmul',
  Div2AllSolve = 'div2-all',
  ...
  Prime = 'prime',
  ProofByAC = 'proof-by-ac',
  Honey = 'honey',
  HelloWorld = 'hello-world',
  FirstGrade = '1st',
  SeqQuery = 'seq-query',
  GoinKnowledge = 'goin-knowledge',
  Float128 = 'float128',
  Lamen = 'lamen',
  JustSilver = 'just-silver',
  SampleAC = 'sample-ac',
  CubeloverMethod = 'cubelover-method',
  AC = 'ac',
  StdSort = 'std-sort',
  RemoveN = 'remove-n',
  FFTMultiplication = 'fft-mul',
  SPFASniped = 'spfa-sniped',
  Misread = 'misread',
  Greedy = 'greedy',
  NotEasy = 'not-easy',
  What = 'what',
  NPow5 = 'n^5',
  ACwhyWALong = 'ac-why-wa-long',
  Confidence = 'confidence',
  StopGiman = 'stop-giman',
  WhatDataStructure = 'what-data-structure',
  Evande = 'evande',
  IamFool = 'i-am-fool',
  HowSolve = 'how-solve',
  WhatAlgorithm = 'what-algorithm',
  Minus2s = '-2s',
  GimanGiveup = 'giman-giveup',
  BecomeGoinmul = 'become-goinmul',
  SCCTarjan = 'scc-tarjan',
  NotWellKnown = 'not-wellknown',
  EmptyPop = 'empty-pop',
  BitEven = 'bit-even',
  Aheui = 'aheui',
  HashBreaking = 'hash-breaking',
  Easy = 'ez',
  Purple = 'purple',
  Cpp17 = 'cpp17',
  ZeroPercentWA = '0wa',
  AboutTLE = '988ms',
  EasyButYouHard = 'easy-but-you-hard',
  EyeGrep = 'eye-grep',
  ElevenDimensionTomato = '11dim-tomato',
  GimanBeSqrt = 'giman-be-sqrt',
  HintPlease = 'hint-plz',
  ACwhyWA = 'ac-why-wa',
  TooBad = 'too-bad',
  NoShort = 'no-short',
  ...
  CounterPlease = 'counter-please',
  Hunsu = 'hunsu',
  LLVMPower = 'llvm-power',
}
...
const PirimMap: Record<Pirim, Tweet> = {
  [Pirim.Judging]: {
  ...
  [Pirim.CubeloverMethod]: {
    ...
    content:
      '큐브러버 메소드(ctrl+a -> delete -> ctrl+s -> alt+F4)를 고민 중인 피림이',
  ...
  [Pirim.FFTMultiplication]: {
    ...
    content:
      '큰 수 곱셈을 FFT로 O(N log N)만에 구할 수 있다는 걸 알게 된 피림이',
  ...
  // should start from https://twitter.com/PSing_Pirim/status/1235423084410048512
};
