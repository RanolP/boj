...
exports.LanguageUsageRule = {
    ...
    execute: function () {
        return __awaiter(this, void 0, void 0, function () {
            var problemList, solutions, ratio;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, problem_1.getProblemList()];
                    case 1:
                        problemList = _a.sent();
                        return [4 /*yield*/, Promise.all(problemList
                                .filter(function (problem) { return problem.isSolved; })
                                .map(function (problem) { return problem.getSolutions(); }))];
                    case 2:
                        solutions = (_a.sent()).flat();
                        ratio = solutions
                            .map(function (solutionPath) { return path_1.parse(solutionPath).ext; })
                            .reduce(function (acc, curr) {
                            var _a;
                            return (__assign(__assign({}, acc), (_a = {}, _a[curr] = curr in acc ? acc[curr] + 1 : 1, _a)));
                        }, {});
                        return [2 /*return*/, [
